...
----------------------------------------------------*/
$social = array (
  'facebook'  => array('url'  => 'http://www.facebook.com/pages/Negeri-Pelangi/197172399682',
        'text' => 'Facebook'
       ),
  'twitter'  => array('url'  => 'http://twitter.com/NegeriPelangi',
        'text' => 'Twitter'
       ),
  'youtube'  => array('url'  => '#',
        'text' => 'Youtube'
       ),
  'gihub'  => array('url'  => 'https://github.com/OpenThink-Labs',
        'text' => 'Github'
       ),
  'forum'  => array('url'  => 'http://groups.google.com/group/negeripelangi',
        'text' => 'Forum'
       )
  );
...
<head>
 ...
 <meta name="description" content="Perpustakaan Keliling Iqra">
 <meta name="keywords" content="perpustakaan keliling, iqra, gerakan literasi">
